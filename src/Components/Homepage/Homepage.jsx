  ...
  const cardData = [
    {
      ...
      h5: "Tools",
      courseDetails:
        "The Front-end web development course is designed to equip learners with the unique skills they need to build and develop a variety of websites and applications using best practices to structure HTML, CSS and Javascript and using frameworks such as React to build powerful and modular applications ",
      background: Frontend,
      img1: html,
      img2: angular,
      img3: react,
